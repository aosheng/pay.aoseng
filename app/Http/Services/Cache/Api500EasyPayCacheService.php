...
class Api500EasyPayCacheService
{
    ...
    public function getCache($tags)
    {
        ...
        foreach ($tasks as $task_base_id) {
            ...
            if (!$get_task) {
                Log::warning('redis warning :' . '['. $tags . '] : ' . 'base_id = ' . $task_base_id);
                continue;
            }
        ...
        Log::info('return_data : ' . print_r($return_data, true));
    ...
    public function deleteCache($tags, $type, $base_id)
    {
        ...
        Log::info('delete list [' . $tags . '_' . $type .'] base_id= ' . $base_id);
    }
    ...
    public function deleteTagsCache($tags, $type, $base_id)
    {
        ...
        Log::info('forget [' . $tags . '_' . $type .'] base_id= ' . $base_id);
    }
}
