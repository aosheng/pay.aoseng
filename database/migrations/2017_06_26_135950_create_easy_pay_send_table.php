...
class CreateEasyPaySendTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('easy_pay_send', function (Blueprint $table) {
            ...
            $table->text('config_signKey')->comment('MD5密鑰'); #'2566AE677271D6B88B2476BBF923ED88';
            $table->text('config_encKey')->comment('3DES密鑰'); #'GiWBZqsJ4GYZ8G8psuvAsTo3';
            ...
            $table->text('sign')->comment('簽名'); #'utf-8';
            $table->timestamps();
        });
    }
